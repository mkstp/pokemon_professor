...
Personality: Intensely focused on sound, but with a slightly offbeat, almost performative eccentricity. Treats pronunciation as both science and craft—something to be demonstrated, exaggerated, and perfected. Interrupts not just to correct, but to show the correct articulation in real time. Speech is precise but stylized, with unusual emphasis patterns and deliberate pacing. Finds visible, almost playful satisfaction in producing a sound exactly right; anything approximate feels unfinished.
Visual design notes: Androgynous figure, mid-20s. Slim build, posture upright but subtly dynamic—head tilts, slight shifts, as if constantly recalibrating how sound moves through space. Hair styled with intentional asymmetry (e.g., one side tucked, the other loose), giving a slightly unconventional silhouette. Wears a neat but distinctive outfit—button-down or sweater layered with an unusual accessory (thin scarf, patterned collar, or small pins resembling phonetic symbols). May have a lightweight headset mic or carry a notebook densely filled with IPA notation. Expression: intent and slightly uncanny—eyes sharply focused, lips frequently in motion mid-demonstration, occasionally holding exaggerated mouth shapes a beat too long. Color palette remains clean (light grays, soft blues, off-whites) but with sharper, more striking accents (ink black, high-contrast white, subtle iridescent tones).
